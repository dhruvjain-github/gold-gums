...
const BestProduct = ({
  ...
  const products = [
    ...
    },
    {
      ...
      description:
        "Premium liquid glucose and starch-based products for diverse industrial applications, ensuring consistent performance.",
      link: "/food-product",
    },
    {
    ...
    },
    {
      ...
      description: "Explore our starch glue, caramel colors, and more.",
      link: "/food-product",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {products.map((product, index) => (
            <Link href={product.link} key={index} passHref>
              <div
                className={`flex flex-col items-start text-left ${boxcolor} p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 cursor-pointer`}
